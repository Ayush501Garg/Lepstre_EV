  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      showCupertinoModalBottomSheet(
        ...
        builder: (context) => BottomSheetSnapContent(stations: stations),
      );
    });
  }
        ...
        body: SafeArea(
          child: Center(
            child: GestureDetector(
              ...
              child: Image.asset(map1, fit: BoxFit.contain),
            ),
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: DraggableScrollableSheet(
        ...
        maxChildSize: 0.95,
        snap: true,
        snapSizes: [250 / screenHeight, 300 / screenHeight, 0.95],
                  ...
                  if (selectedStation != null) ...[
                    GestureDetector(
                      onVerticalDragUpdate: (details) {
                        ...
                        newSize = newSize.clamp(250 / screenHeight, 0.95);
