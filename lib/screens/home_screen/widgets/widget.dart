...
Widget buildSpeedLockSection(BuildContext context) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
        context,
...
Widget buildLockEvFeatureSection(BuildContext context) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
        context,
...
class _BatteryInfoCardState extends State<BatteryInfoCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          // Left: Big Battery
          buildBatteryVisual(percent, getBatteryColor()),
  ...
  Widget buildBatteryVisual(int percent, Color fillColor) {
    return Column(
      children: [
        // Battery Cap
        Container(
...
Widget buildAdvancedSection(BuildContext context) {
...
Widget buildFullWidthBuyEVSection() {
  return Padding(
    padding: const EdgeInsets.symmetric(horizontal: 15),
    child: ClipRRect(
...
Widget buildChargingStationSection(BuildContext context) {
  return Padding(
